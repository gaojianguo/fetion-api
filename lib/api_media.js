 ...
 * 详情请见：<http://gz.feixin.10086.cn/Open/Index/apidoc/flag/4-4#gr1>
 * Examples:
 * ```
...
/**
 * 下载多媒体文件
 * 详情请见：<http://gz.feixin.10086.cn/Open/Index/apidoc/flag/4-4#gr2>
 * Examples:
 * ```
...
exports._getMedia = function (mediaId, callback) {
  var url = this.prefix + 'downfile?access_token=' + this.token.accessToken + '&media_id=' + mediaId;
  var opts = {
    timeout: 60000 // 60秒超时
  };
