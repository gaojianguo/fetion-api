...
/**
 * 创建自定义菜单
 * 详细请看：http://gz.feixin.10086.cn/Open/Index/apidoc/flag/6-1
 *
 * Menu:
 * ```
 * {
...
/**
 * 获取菜单
 * 详细请看：<http://gz.feixin.10086.cn/Open/Index/apidoc/flag/6-2>
 *
 * Examples:
 * ```
 ...
 *{"menu":{"button":[{"type":"click","name":"今日歌曲
 ...
 ","key":"V1001_TODAY_SINGER","sub_button":[]},{"name":"菜单","sub_button":[{"type":"view","name":"
 搜索","url":"http://www.soso.com/","sub_button":[]},{"type":"view","name":"视频
...
/**
 * 删除自定义菜单
 * 详细请看：<http://gz.feixin.10086.cn/Open/Index/apidoc/flag/6-3>
 * Examples:
 * ```
